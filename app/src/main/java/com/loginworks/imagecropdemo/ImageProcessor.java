...
public class ImageProcessor {
    ...
    public enum Direction {VERTICAL, HORIZONTAL, NINTY, NONE}
    ...
    public Bitmap resizeAndRotate(float scaleFactor, Bitmap src, Direction rotateType) {
    ...
    private Matrix rotateLogic(float scaleFactor, Direction rotateType) {
        ...
        } else if (rotateType.equals(Direction.NINTY)) {
            matrix.setRotate(-90);
            matrix.preScale(scaleFactor, -1f * scaleFactor);
        } else {
            imageProcessorError();
